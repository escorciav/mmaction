...
python dump_metadata.py ../data/thumos14/videos_val/ ../data/thumos14/rawframes/ --level 1 --ext mp4
...
python dump_metadata.py ../data/thumos14/videos_test/ ../data/thumos14/rawframes/ --level 1 --ext mp4
