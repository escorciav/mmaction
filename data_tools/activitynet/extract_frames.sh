...
python build_rawframes.py ../data/activitynet/v1-3/val ../data/activitynet/rawframes/ --level 2 --flow_type tvl1 --ext all --ignore_level_out | tee activitynet/log_v1-3_test.txt &&
